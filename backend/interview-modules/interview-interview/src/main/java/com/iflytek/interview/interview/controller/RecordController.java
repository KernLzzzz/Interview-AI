...
public class RecordController {
    ...
    public Result<EvaluationTaskVO> submit(@PathVariable Long id,
                                           @Valid @RequestBody SubmitInterviewDTO submission) {
        return Result.success(recordService.submitInterview(
                id, SecurityUtil.getCurrentUserId(), submission));
    }
