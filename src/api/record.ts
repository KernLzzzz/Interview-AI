...
import type { InterviewRecord, AnswerQuestion } from '@/types'
...
export function submitRecordApi(id: number, answerData: string): Promise<null> {
  return request<null>({ url: `/records/${id}/submit`, method: 'POST', data: { answerData } })
}
